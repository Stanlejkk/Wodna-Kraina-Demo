        ...
        <div className="max-w-5xl mx-auto">
          ...
          <ScrollFadeIn>
            <div className="text-center mt-10">
              <Link
                href="/oplaty"
                className="inline-flex items-center gap-2 px-8 py-4 bg-accent text-background font-semibold rounded-md hover:bg-accent-light transition-all hover:shadow-lg hover:shadow-accent/20 text-lg"
              >
              ...
              <div className="flex flex-col justify-center space-y-6">
                ...
                <div className="p-6 rounded-lg border border-border bg-card">
                  ...
                  <a
                    ...
                    className="text-foreground/60 hover:text-accent transition-colors text-lg"
                  >
                    512 464 846
                  </a>
                </div>
                <div className="p-6 rounded-lg border border-border bg-card">
                  ...
                  <p className="text-foreground/60">Pn-Nd: 08:00 – 21:00</p>
                  <p className="text-foreground/60">Dla karpiarzy: 24h</p>
                </div>
              </div>
            </ScrollFadeIn>
          </div>
